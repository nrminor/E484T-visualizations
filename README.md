...
Last updated: 02-March-2022 by Nicholas R. Minor
...
1. __Figure 1A__ - Ct values through the course of a prolonged SARS-CoV-2 infection lasting 486+ days
...
With this file architecture in place, use the following line of code to run the workflow:

`bash prolonged_infection_workflow_wrapper_dockerized.sh -w /absolute/path/to/prolonged_infection_workflow`

Depending on available RAM and processing speed, the workflow will likely take a day to two days to finish.
